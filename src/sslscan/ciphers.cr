module SSLScan
    SSLV2   = [OpenSSL::SSL::Options::NO_SSL_V3, OpenSSL::SSL::Options::NO_TLS_V1, OpenSSL::SSL::Options::NO_TLS_V1_1, OpenSSL::SSL::Options::NO_TLS_V1_2]
    SSLV3   = [OpenSSL::SSL::Options::NO_SSL_V2, OpenSSL::SSL::Options::NO_TLS_V1, OpenSSL::SSL::Options::NO_TLS_V1_1, OpenSSL::SSL::Options::NO_TLS_V1_2]
    TLSV1   = [OpenSSL::SSL::Options::NO_SSL_V2, OpenSSL::SSL::Options::NO_SSL_V3, OpenSSL::SSL::Options::NO_TLS_V1_1, OpenSSL::SSL::Options::NO_TLS_V1_2]
    TLSV1_1 = [OpenSSL::SSL::Options::NO_SSL_V2, OpenSSL::SSL::Options::NO_SSL_V3, OpenSSL::SSL::Options::NO_TLS_V1, OpenSSL::SSL::Options::NO_TLS_V1_2]
    TLSV1_2 = [OpenSSL::SSL::Options::NO_SSL_V2, OpenSSL::SSL::Options::NO_SSL_V3, OpenSSL::SSL::Options::NO_TLS_V1, OpenSSL::SSL::Options::NO_TLS_V1_1]
    ...
    def self.ciphers
      list = %x(openssl ciphers "ALL:COMPLEMENTOFALL:HIGH:MEDIUM:LOW").strip.split(":")
      if list.empty?
